...
- Record the failed-closed native-alias pilot v1, v3, and v4 incidents; no native-alias release or model-performance claim is made.
...
- Retire unexecuted pilot v2 and permanently close consumed pilots v3 and v4 after their fail-closed sessions; neither may resume or retry.
- Freeze hard-disabled pilot v5 on the two stable Luna and Sol routes: 48 paired sessions and at most 576 requests, with a new null anchor, approval chain, and external reservation.
