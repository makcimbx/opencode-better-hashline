...
import { nativeAliasPilotV3 } from "../benchmarks/model/adapters.js";
...
describe("model benchmark paid gates", () => {
  test("freezes the complete proposed native alias pilot schedule in dry-run mode", () => {
    ...
    expect(result.stdout.toString()).toContain(nativeAliasPilotV3.scheduleManifestSha256);
  });
  ...
  test("keeps paid v3 execution hard-disabled even with dirty override", () => {
